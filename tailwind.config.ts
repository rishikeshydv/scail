...
const config = {
  ...
  content: [
    ...
    "./app/**/*.{ts,tsx}",
    "./src/**/*.{ts,tsx}",
    "./node_modules/@nextui-org/theme/dist/components/(dropdown|input|progress|select|menu|divider|popover|button|ripple|spinner|listbox|scroll-shadow).js"
  ],
  prefix: "",
  theme: {
  	container: {
  	...
  	extend: {
  		...
  		backgroundImage: {
			...
			'prop-ai-dark':"url('/images/prop-bg-2.png')",
