  ...
  return (
    <main>
        ...
        <div className="flex flex-col items-center p-4 md:flex-row md:items-start md:space-x-16">
            <div className="flex flex-col items-center space-y-12 md:w-1/2 overflow-y-auto">
        <div className="flex flex-col items-center space-y-4">
        <img
          src="/images/new-prop-img.jpeg"
          alt="Luxury villa in Texas"
          className="rounded-[40px] h-[500px] w-[894px] object-cover aspect-auto"
        />
      ...
      <div className="space-y-5">
        <h2 className="text-[40px] font-bold">Suggested Properties</h2>
        ...
        <p className="text-base text-[18px] text-[#808080]">
          Spacious and Bright Townhouse 1 Bedroom, 1 LOFT/Den, 1 FULL BATH & 1 HALF BATH. WASHER AND DRYER, GAS STOVE
          AND WATER HEATER. STORAGE. WATER VIEW WITH SCREENED-IN PATIO. ASSIGNED PARKING SPACE IN FRONT OF RESIDENCE.PET
          FRIENDLY. EASY ACCESS TO SAWGRASS EXPRESSWAY A RATED SCHOOLS.LOW MAINTENANCE FEE $ 300. Tenant Occupied.
        </p>
      </div>
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-1 gap-4 p-[34px] bg-gray-100 rounded-lg md:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            <h4 className="text-lg font-semibold">Heating and Cooling</h4>
            <ul className="list-disc list-inside text-[#808080]">
              <li className="mt-[8px]">Cooling Features: Central Air</li>
      ...
      <div className="space-y-8">
      <div className="space-y-2">
        <h2 className="text-[25px] font-bold">Property Taxes and Assessment</h2>
        ...
        <p className="text-sm text-muted-foreground">Home facts updated by county records</p>
      </div>
      <div className="space-y-2">
      ...
      <div className="flex flex-col space-y-3 md:w-1/2 sticky top-0">
        <h1 className="text-[40px] font-bold">Luxury villa in Texas</h1>
        <div className="text-[30px] font-bold text-[#0874de]">$6,89,000</div>
        <div className="text-gray-500 flex gap-1"><span className="text-black font-semibold">Est. Payment:</span> $1,692/month <span><svg width="20" height="20" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M9.62132 23.835L24.8344 8.6218L22.7132 6.50047L7.5 21.7137V23.835H9.62132ZM10.864 26.835H4.5V20.471L21.6525 3.31849C22.2384 2.73271 23.1881 2.73271 23.7738 3.31849L28.0166 7.56113C28.6023 8.14691 28.6023 9.09666 28.0166 9.68244L10.864 26.835ZM4.5 29.835H31.5V32.835H4.5V29.835Z" fill="#0874DE"/>
</svg>
</span></div>
        <div className="grid grid-cols-4 gap-4">
          <div className="flex flex-col items-center p-4 border rounded-lg">
          <svg width="35" height="35" viewBox="0 0 64 65" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="hotel-bed-line 1">
<path id="Vector" d="M58.6673 30.1917V54.1917H53.334V46.1917H10.6673V54.1917H5.33398V11.525H10.6673V38.1917H32.0006V19.525H48.0006C53.8916 19.525 58.6673 24.3007 58.6673 30.1917ZM53.334 38.1917V30.1917C53.334 27.2462 50.9462 24.8584 48.0006 24.8584H37.334V38.1917H53.334ZM21.334 30.1917C22.8067 30.1917 24.0007 28.9978 24.0007 27.525C24.0007 26.0523 22.8067 24.8584 21.334 24.8584C19.8612 24.8584 18.6673 26.0523 18.6673 27.525C18.6673 28.9978 19.8612 30.1917 21.334 30.1917ZM21.334 35.525C16.9157 35.525 13.334 31.9434 13.334 27.525C13.334 23.1068 16.9157 19.525 21.334 19.525C25.7523 19.525 29.334 23.1068 29.334 27.525C29.334 31.9434 25.7523 35.525 21.334 35.525Z" fill="#0874DE"/>
</g>
</svg>
            <div>Bedrooms</div>
          </div>
...
<rect y="0.798584" width="50" height="50" rx="25" fill="white"/>
<rect x="0.657895" y="1.45648" width="48.6842" height="48.6842" rx="24.3421" stroke="black" stroke-opacity="0.05" stroke-width="1.31579"/>
<path d="M29.1169 24.8116L23.8235 19.5182L25.2191 18.1226L32.8949 25.7984L25.2191 33.4742L23.8235 32.0786L29.1169 26.7853H17.1055V24.8116H29.1169Z" fill="#0874DE"/>
</svg>
        ...
        <div className="flex space-x-4">
          <Button variant="default" className="bg-[#0874de] text-white rounded-[50px]">
            Request tour&nbsp;<svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12.1287 8.99992L8.1057 4.97692L9.16635 3.91626L15 9.74992L9.16635 15.5835L8.1057 14.5229L12.1287 10.4999H3V8.99992H12.1287Z" fill="white"/>
</svg>

          </Button>
          <Button variant="default" className="bg-black text-white rounded-[50px]">
            Contact agent&nbsp;<svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12.1287 8.99992L8.1057 4.97692L9.16635 3.91626L15 9.74992L9.16635 15.5835L8.1057 14.5229L12.1287 10.4999H3V8.99992H12.1287Z" fill="white"/>
</svg>
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-2xl font-bold tracking-tight text-foreground">PropAI Price Estimator</h2>
          <p className="mt-2 text-muted-foreground md:text-md">
            Get your personalized price estimate for this property.
          </p>
          <div className="mt-2">
            <span className="block text-5xl font-bold text-[#0874de]">$725,000</span>
          </div>
        </div>
      </div>
    </div>
              ...
              {[
                ...
                <tr key={index} className="border-t">
                  <td className="px-4 py-2 flex gap-2">
                    <svg width="12" height="17" className="mt-1" viewBox="0 0 12 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5.25 15.625C3.625 13.5938 0 8.75 0 6C0 2.6875 2.65625 0 6 0C9.3125 0 12 2.6875 12 6C12 8.75 8.34375 13.5938 6.71875 15.625C6.34375 16.0938 5.625 16.0938 5.25 15.625ZM6 8C7.09375 8 8 7.125 8 6C8 4.90625 7.09375 4 6 4C4.875 4 4 4.90625 4 6C4 7.125 4.875 8 6 8Z" fill="#469D62"/>
                    </svg>
{item.address}</td>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 h-full gap-8">
        <div>
          <h2 className="text-[25px] font-bold mb-4">Frequently Asked Questions</h2>
          <div>
...
<rect width="32" height="32" fill="white" transform="translate(0 0.125)"/>
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">This property's flood risk is not changing.</p>
                </div>
...
<rect width="32" height="32" fill="white" transform="translate(0 0.875)"/>
      ...
      <section className="min-h-[100vh] w-full pt-10">
